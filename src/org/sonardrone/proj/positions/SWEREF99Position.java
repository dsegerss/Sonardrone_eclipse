...
import org.sonardrone.proj.GaussKreuger;
...
public class SWEREF99Position extends Position {
	...
	public enum SWEREFProjection {
		...
		sweref_99_tm, sweref_99_12_00, sweref_99_13_30, sweref_99_15_00, sweref_99_16_30, sweref_99_18_00, sweref_99_14_15, sweref_99_15_45, sweref_99_17_15, sweref_99_18_45, sweref_99_20_15, sweref_99_21_45, sweref_99_23_15
	}

	private SWEREFProjection projection;

	/**
	 * Create a SWEREF99 position from double values with SWEEREF 99 TM as
	 * default projection
	 * 
	 * @param n
	 *            North value
	...
	/**
	 * Create a SWEREF99 position from double values. Suplly the projection for
	 * values other than SWEREF 99 TM
	 * 
	 * @param n
	 *            North value
	 * @param e
	...
	public SWEREF99Position(WGS84Position position, SWEREFProjection projection) {
		...
		double[] lat_lon = gkProjection.geodetic_to_grid(
	...
	public WGS84Position toWGS84() {
		...
		double[] lat_lon = gkProjection.grid_to_geodetic(this.latitude,
				this.longitude);
	...
	public String toString() {
		return String.format("N: %f E: %f Projection: %s", this.latitude,
				this.longitude, getProjectionString());
	}
}
