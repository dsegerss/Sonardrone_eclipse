...
public class RT90Position extends Position {
	...
	public enum RT90Projection {
		...
		rt90_7_5_gon_v, rt90_5_0_gon_v, rt90_2_5_gon_v, rt90_0_0_gon_v, rt90_2_5_gon_o, rt90_5_0_gon_o
	}
	...
	public String toString() {
		return String.format("X: %f Y: %f, Projection %s", this.latitude,
				this.longitude, this.getProjectionString());
	}
}
